...
import team.terrafirmgreg.fieldguide.data.minecraft.blockmodel.ElementRotation;
import team.terrafirmgreg.fieldguide.data.minecraft.blockmodel.ModelElement;
...
public class BaseModelBuilder {
    ...
    protected static final Vector4f LIGHT = new Vector4f(1f, 1f, 1f, 1f);      
    protected static final Vector4f LIGHT_GRAY = new Vector4f(0.8f, 0.8f, 0.8f, 1f);  
    protected static final Vector4f DARK_GRAY = new Vector4f(0.6f, 0.6f, 0.6f, 1f);   
    protected static final Vector4f DARK = new Vector4f(0.5f, 0.5f, 0.5f, 1f);        
